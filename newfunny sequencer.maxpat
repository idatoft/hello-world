...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 490.0, 1434.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 974.554688, 1097.0, 42.0, 20.0 ],
					"text" : "* 0.01"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 916.554688, 1137.0, 77.0, 20.0 ],
					"text" : "pak 100. 80."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 916.554688, 1188.0, 50.5, 20.0 ],
					"text" : "* 0.95"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 916.554688, 957.0, 137.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 509.645996, 1342.812744, 33.0, 20.0 ],
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 509.645996, 1294.812744, 32.5, 18.0 ],
					"text" : "5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 556.554688, 1294.812744, 32.5, 18.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 556.554688, 1258.812744, 96.0, 20.0 ],
					"text" : "delay 20"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 556.554688, 1198.812744, 36.0, 20.0 ],
					"text" : "sel 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 411.214905, 1342.812744, 32.5, 20.0 ],
					"text" : "!= 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 521.395996, 856.812744, 32.5, 20.0 ],
					"text" : "i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 224.008545, 704.002808, 32.5, 20.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 224.008545, 768.038208, 166.757568, 20.0 ],
					"text" : "switch 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 371.766113, 704.002808, 95.0, 20.0 ],
					"text" : "edge~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 371.766113, 663.953979, 47.0, 21.0 ],
					"text" : ">~ 2.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 411.214905, 1380.592285, 117.431091, 20.0 ],
					"text" : "gate~ 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 641.202881, 676.202637, 191.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 586.171143, 639.202637, 191.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 531.139404, 604.202637, 191.0, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 477.566406, 252.538712, 67.0, 18.0 ],
					"text" : "routepass 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 746.396973, 198.248795, 47.0, 18.0 ],
					"text" : "route -1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 412.094238, 152.248917, 353.302734, 18.0 ],
					"text" : "unpack i i i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 297.887329, 477.435242, 32.5, 18.0 ],
					"text" : "+ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 297.887329, 526.011414, 300.358276, 18.0 ],
					"text" : "switch 2"
				}
...
,
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 412.094238, 113.708389, 59.5, 18.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 579.245605, 394.910889, 214.151367, 18.0 ],
					"saved_object_attributes" : 					{
...
,
					"patching_rect" : [ 579.245605, 433.091553, 79.0, 18.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 438.566406, 380.011475, 120.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 438.566406, 422.011475, 88.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 579.245605, 253.538712, 53.0, 16.0 ],
					"text" : "active $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 476.107544, 740.602539, 184.095337, 18.0 ],
					"text" : "switch 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 476.395996, 876.502808, 32.5, 16.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 431.395996, 917.189575, 109.0, 18.0 ],
					"text" : "counter 1 16"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 556.554688, 980.189575, 103.0, 16.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 19.582031, 134.011475, 58.0, 20.0 ],
					"restore" : 					{
						"ClockSelect" : [ 1.0 ],
...
, 			{
		...
		"parameters" : 		{
			"obj-9" : [ "gatepct", "gatepct", 0 ],
			"obj-120" : [ "Max pulse", "Max pulse", 0 ],
			"obj-28" : [ "Attack", "Attack", 0 ],
			"obj-139" : [ "ClockSelect", "ClockSelect", 0 ],
